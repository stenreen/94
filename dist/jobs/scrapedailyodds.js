...
async function main() {
    ...
    try {
        ...
        for (const match of matches) {
            ...
            const sourceKey = makeSourceKey(sample.source, sample.event_id, sample.league, sample.home_team_norm, sample.away_team_norm, sample.commence_time, sample.bookmaker);
