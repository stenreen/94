...
export async function listActiveSports() {
    ...
    for (const bookmaker of bookmakers) {
        ...
        for (const outcome of market.outcomes) {
            ...
            if (name === homeNorm)
                ...
                two = outcome.price;
            else if (["draw", "tie", "x"].includes(name))
                draw = outcome.price;
        }
...
export async function scrapeTheOddsApiDailyOdds() {
